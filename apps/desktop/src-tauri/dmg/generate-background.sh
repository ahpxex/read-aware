#!/usr/bin/env bash
# Renders background.html to background.png (1320x600 pixels stamped as
# 144 dpi, so Finder displays it at 660x300 points, crisp on Retina).
...
"$CHROME" --headless=new --disable-gpu --hide-scrollbars \
  --force-device-scale-factor=2 --window-size=660,300 \
