...
const permissionKeys: Record<
  ChatPermissionAction,
  {
    question: `chat.interaction.permission.${"deleteBook" | "deleteBooks" | "deleteCollection" | "deleteAnnotation" | "manageMemory" | "classifyBook" | "generateBookGraph" | "clearConversation" | "syncNow" | "manageSchedule" | "accessBookFile" | "importResource" | "mergeBooks" | "pluginTool" | "downloadResource"}.question`;
    description: `chat.interaction.permission.${"deleteBook" | "deleteBooks" | "deleteCollection" | "deleteAnnotation" | "manageMemory" | "classifyBook" | "generateBookGraph" | "clearConversation" | "syncNow" | "manageSchedule" | "accessBookFile" | "importResource" | "mergeBooks" | "pluginTool" | "downloadResource"}.description`;
    approve: `chat.interaction.permission.${"deleteBook" | "deleteBooks" | "deleteCollection" | "deleteAnnotation" | "manageMemory" | "classifyBook" | "generateBookGraph" | "clearConversation" | "syncNow" | "manageSchedule" | "accessBookFile" | "importResource" | "mergeBooks" | "pluginTool" | "downloadResource"}.approve`;
  }
> = {
  "download-resource": {
  ...
  "access-book-file": {
    ...
    approve: "chat.interaction.permission.accessBookFile.approve",
  },
  "manage-schedule": {
  ...
  "sync-now": {
    ...
    approve: "chat.interaction.permission.syncNow.approve",
  },
  "clear-conversation": {
    question: "chat.interaction.permission.clearConversation.question",
    description: "chat.interaction.permission.clearConversation.description",
    approve: "chat.interaction.permission.clearConversation.approve",
  },
  "generate-book-graph": {
    question: "chat.interaction.permission.generateBookGraph.question",
    description: "chat.interaction.permission.generateBookGraph.description",
    approve: "chat.interaction.permission.generateBookGraph.approve",
  },
  "classify-book": {
    question: "chat.interaction.permission.classifyBook.question",
    description: "chat.interaction.permission.classifyBook.description",
    approve: "chat.interaction.permission.classifyBook.approve",
  },
  "manage-memory": {
    question: "chat.interaction.permission.manageMemory.question",
    description: "chat.interaction.permission.manageMemory.description",
    approve: "chat.interaction.permission.manageMemory.approve",
  },
  "delete-book": {
