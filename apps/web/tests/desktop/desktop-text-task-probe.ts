...
import { fileContentVersion, registerActiveBookContent } from "../../src/features/library/lib/book-content-source";
import { deleteBookText, ensureBookTextExtracted } from "../../src/features/library/lib/book-text-store";
import { getDesktopBlobInfo } from "../../src/platform/blob-store";
