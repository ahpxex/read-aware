...
- 宿主：实装 202、部分 39、非桌面 1、待建 1。
- Agent：接通 147、部分 50、扩展 11、自动 13、未接 13、接通（待 E2E） 9。
- 插件：接通 162、部分 66、未接 5、接通（待 E2E） 10。
