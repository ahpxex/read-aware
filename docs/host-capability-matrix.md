...
| <a id="LIB15"></a>LIB15 | 列出集合及其成员 | 实装 | **接通**：list_collections[全局]<br>[设计] 查询工具 | **接通**：library.queries.collections.list/booksIn<br>[设计] 只读领域 | Library Desk 0.8；书架；Agent | 集合单归属模型保持不变 | [LIB](../apps/web/src/domain/library.ts) [SHELFTOOLS](../packages/agent/src/tools/shelf-tools.ts) [CTX](../apps/web/src/features/plugins/runtime/plugin-context.ts) [LIBRARYCOLLECTIONS](../plugins/library-desk/src/collections.ts) [LIBRARYORGANIZEPROOF](../plugins/library-desk/tests/organize.test.ts) | B03 |
| <a id="LIB16"></a>LIB16 | 创建/重命名集合 | 实装 | **接通**：manage_collection[全局]<br>[设计] 写工具 | **接通**：collections.create/rename<br>[设计] 写领域 | Library Desk 0.8；书架；Agent | 书内不注册全局集合管理工具是明确 scope 策略 | [LIB](../apps/web/src/domain/library.ts) [SHELFTOOLS](../packages/agent/src/tools/shelf-tools.ts) [CTX](../apps/web/src/features/plugins/runtime/plugin-context.ts) [LIBRARYCOLLECTIONS](../plugins/library-desk/src/collections.ts) [LIBRARYORGANIZEPROOF](../plugins/library-desk/tests/organize.test.ts) | B03 |
| <a id="LIB17"></a>LIB17 | 删除集合 | 实装 | **接通**：delete_collection[全局] + 批准<br>[设计] 受控写工具 | **接通**：collections.remove<br>[设计] 写领域/风险策略 | Library Desk 0.8；书架；Agent | 删除集合与删除其中书籍是不同操作 | [LIB](../apps/web/src/domain/library.ts) [SHELFTOOLS](../packages/agent/src/tools/shelf-tools.ts) [CTX](../apps/web/src/features/plugins/runtime/plugin-context.ts) [LIBRARYCOLLECTIONS](../plugins/library-desk/src/collections.ts) [LIBRARYORGANIZEPROOF](../plugins/library-desk/tests/organize.test.ts) | B03 |
| <a id="LIB18"></a>LIB18 | 批量分配/移出集合 | 实装 | **接通**：manage_collection.assign[全局]<br>[设计] 批量写工具 | **接通**：collections.assignBooks<br>[设计] 批量写领域 | Library Desk 0.8；书架拖放/多选；Agent | 移动书籍只是成员变更，不是文件移动 | [LIB](../apps/web/src/domain/library.ts) [SHELFTOOLS](../packages/agent/src/tools/shelf-tools.ts) [CTX](../apps/web/src/features/plugins/runtime/plugin-context.ts) [LIBRARYCOLLECTIONS](../plugins/library-desk/src/collections.ts) [LIBRARYORGANIZEPROOF](../plugins/library-desk/tests/organize.test.ts) | B03 |
