...
| <a id="EXT10"></a>EXT10 | RSS 订阅/刷新/退订/OPML/阅读文章 | 实装 | **扩展**：list_feeds/subscribe_feed/refresh_feed/unsubscribe_feed[全局]<br>[设计] 插件工具 | **接通**：RSS 私有 collection + content provider<br>[设计] 现有原语组合 | RSS 0.10 | 私有正文缓存、稳定文章身份、更新通知及显式源重载已接；退订经宿主确认URL/bookId并在同URL队列内重验绑定；OPML 无 Agent 工具；位置迁移和集中原生验收仍见 LIB14 | [RSS](../plugins/rss-reader/src/index.ts) [RSSTOOLS](../plugins/rss-reader/src/agent-tools.ts) [RSSVIEWS](../plugins/rss-reader/src/views.ts) [RSSFEED](../plugins/rss-reader/src/feed.ts) [RSSLIB](../plugins/rss-reader/src/feed-library.ts) [RSSCACHE](../plugins/rss-reader/src/content-cache.ts) [RSSCACHEPROOF](../plugins/rss-reader/tests/feed-library.test.ts) | 新增盘点 |
...
- Plugin Agent contribution：11 个。
...
| `rss-reader` | [EXT10](#EXT10) | [代码] 源码版本 0.10.0；源码存在不等于打包、安装、启用或模型可调用 |
