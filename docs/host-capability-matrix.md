...
- Agent：接通 150、部分 44、扩展 11、接通（待 E2E） 12、自动 13、未接 13。
- 插件：接通 165、部分 60、接通（待 E2E） 13、未接 5。
