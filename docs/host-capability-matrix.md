...
| <a id="EXT10"></a>EXT10 | RSS 订阅/刷新/退订/OPML/阅读文章 | 实装 | **扩展**：list_feeds/subscribe_feed/refresh_feed/unsubscribe_feed/import_opml[全局]<br>[设计] 插件工具 | **接通**：RSS 私有 collection + content provider<br>[设计] 现有原语组合 | RSS 0.11 | 私有正文缓存、稳定文章身份、更新通知及显式源重载已接；退订经宿主确认URL/bookId并在同URL队列内重验绑定；OPML本地UTF-8文件预填与经确认的Agent文本分批导入已接，默认10/最大20、并发4，区分新增/已有/失败；总文档1MiB/1000源，Agent文本8000字符另受批准预算。既有订阅不刷新，失败不保证回滚，不自动跑下一批；位置迁移边界仍见 LIB14；OPML/Agent 集中原生验收未完成 2026-09-11 真实 RSS0.11 Worker/Tauri 已验订阅/刷新/稳定文章导航、503保留数据、源关闭且Worker重启后缓存阅读、退订清理；自有SQL计数0，900/600宽前台画面已验。无宿主API改动，不覆盖应用重启/远程媒体/OPML或Agent模型。 | [RSS](../plugins/rss-reader/src/index.ts) [RSSTOOLS](../plugins/rss-reader/src/agent-tools.ts) [RSSVIEWS](../plugins/rss-reader/src/views.ts) [RSSFEED](../plugins/rss-reader/src/feed.ts) [RSSLIB](../plugins/rss-reader/src/feed-library.ts) [RSSCACHE](../plugins/rss-reader/src/content-cache.ts) [RSSCACHEPROOF](../plugins/rss-reader/tests/feed-library.test.ts) [RSSOPML](../plugins/rss-reader/src/opml-import.ts) [RSSOPMLFILE](../plugins/rss-reader/src/opml-file.ts) [RSSOPMLPROOF](../plugins/rss-reader/tests/opml-file.test.ts) [RSSCOMPOSITIONPROOF](../docs/evidence/rss-composition-2026-09-11.json) | 新增盘点 |
...
| `rss-reader` | [EXT10](#EXT10) | [代码] 源码版本 0.11.0；源码存在不等于打包、安装、启用或模型可调用 |
