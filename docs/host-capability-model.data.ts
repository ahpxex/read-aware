...
export const scenarios = [
  ...
  ["句读与 TTS", "D2 C2 C3 D5 Q2", "reading 2.1 已将朗读 start/stop、实际播放状态、单元 CFI 与 fallback 接到 Agent/插件；Listening Desk 组合朗读和导航历史。隔离 macOS Tauri 验证双端互控、自动续读、系统回退、发起插件停用与关闭时的迟到合成隔离。模式启停/步进/恢复 READ16 仍未接；release、其他系统、远端 TTS 未验。"],
