...
export const units: Unit[] = [
  ...
  unit("D2", "Domain", "reading", "阅读会话、导航、模式、播放与统计", "TXT09-10 READ01-09 READ12-20 STAT01-05", "domains.reading",
    ...
    "读、导航/呈现、持久写分清授权风险；reading 2.9 的 session.selection/观察与 selectionActions 1.2 已提供捕获版本的选区 Range，当前句段复用匹配的 position，不给旧标注补签版本。Text Desk 0.6 在真实 FB2/PDF 及句段菜单消费；Agent 同源查询受隐私与原始剧透限制。中途启用先读快照再观察；贡献模式/声音并不授权控制用户播放。公共设置/清除选区与临时强调 owner/释放仍待建。",
