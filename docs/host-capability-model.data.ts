...
export const scenarios = [
  ...
  ["句读与 TTS", "D2 C2 C3 D5 Q2", "reading 2.3 已共享朗读、模式快照/启停/单位配置及版本化位置返回；Listening Desk 组合模式表单、朗读、导航历史和 Current passage。返回等待导航及分段恢复，失败/取消不提交成功历史；无版本旧地址不恢复。隔离 macOS Tauri 验证慢分段返回、拒绝、模式变更取消，其他启停/朗读边界见此前证据。READ16 公共单元步进/跟随、跨节/全书末尾完成、任意 provider 选择仍缺；release、其他系统、远端 TTS 未验。"],
