...
export const units: Unit[] = [
  ...
  unit("D4", "Domain", "conversations", "对话内容、线程及回合意图", "AI01-03 MEM12", "domains.conversations",
    ...
    "已接 get_conversation_state 双 scope 与 manage_conversation 全局创建/选择/停止/批准清空；拒绝工具停止/清空执行自身的线程。与宿主 thread.run 分离，不递归启动自身。用户触发的发送/重试意图仍待接，重试需沿用原附件/来源。",
    "conversations 1.1 已接创建/选择/停止/清空与运行态初始/变化观察，读写分权；空全局草稿只持久选择，首条消息才建 transcript。stop/clear 等最后回合持久写；定向测试已验，集中 Tauri E2E 待验。待确认文本草稿/发送/重试仍缺；不能伪造 role 历史，llm.ask 不是产品聊天。",
