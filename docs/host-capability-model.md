...
| ANN08 | 按 ID 读取、分页、批量/版本冲突标注操作 / 部分 | 部分：get_annotations(annotationId 或 limit/cursor)；edit/delete/open_book 精确查 ID | 部分：annotations v1.2 queries.get/page + 单项命令 | Agent 查询/编辑/删除/按标注导航；桌面 Worker；原生按 createdAt/id 倒序取 1–100 行，默认 20；游标绑定 bookId/kind/query。缺失 get 为 null，模型精确查询为 items 零/一项页；ID 与 query/cursor 互斥。Tauri 已测游标双端续读、条件错配、权限和边界删除/新增；live 非冻结快照。批次/CAS、超长单行文本预算、远端失效仍未完成 | [D3](#D3) | [ANNDB](../apps/web/src/features/annotations/lib/annotation-db.ts) [ANNPAGES](../apps/desktop/src-tauri/src/storage/annotation_pages.rs) [ANNOT](../apps/web/src/domain/annotations.ts) [ANNTOOLS](../packages/agent/src/tools/annotation-tools.ts) [LIBTOOLS](../packages/agent/src/tools/library-tools.ts) [ANNPORT](../apps/web/src/features/ai/agent/ports/annotations-port.ts) [ANNPAGEPROBE](../apps/web/src/features/plugins/runtime/fixtures/desktop-annotation-page-probe.ts) [API](../packages/plugin-types/src/index.ts) |
