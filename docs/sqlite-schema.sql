...
CREATE TABLE memories ( -- [projection] 长期记忆；正文和全部检索信号都在 SQLite（FTS + scope/recency/importance；默认无向量索引）。由 memory.promoted/revised/superseded/feedback/forgotten 重放。前瞻，暂无生产者。
