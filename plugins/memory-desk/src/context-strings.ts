const en = {
  ...
  emptySummary: "Empty summary", bookSummary: "Conversation summary", local: "Device-local", syncable: "Syncable",
};
const zh: typeof en = {
  ...
  emptySummary: "摘要为空", bookSummary: "对话摘要", local: "仅本机", syncable: "可同步",
};
