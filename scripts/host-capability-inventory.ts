...
const agentMap = pairs([
  ...
  ["open_maintenance_settings", "SYS15 SYS16 EXT12 OPS08 OPS09 CFG08"],
...
const pluginMap = pairs([
  ...
  ["services.maintenance.openSettings", "SYS15 SYS16 EXT12 OPS08 OPS09 CFG08"],
