...
const agentMap = pairs([
  ...
  ["capture_context_bundle list_context_bundles read_context_bundle export_context_bundle", "MEM13"],
  ["update_user_profile", "MEM07"],
  ["ask_user", "AI04"], ["ask_user_form", "EXT05"], ["get_settings update_settings", "CFG01"],
...
const pluginMap = pairs([
  ...
  ["domains.memory.queries.entities domains.memory.queries.profileContext domains.memory.commands.decideEntity", "MEM08"],
  ["domains.memory.queries.context.history domains.memory.queries.context.read domains.memory.queries.context.export domains.memory.commands.context.capture", "MEM13"],
  ...
  ["domains.memory.events.observe", "MEM01 MEM04 MEM05 MEM06 MEM08 MEM09 MEM10 MEM11"],
  ...
  ["services.storage.getDurable", "SYS01 MEM13"],
...
const nativeMap = pairs([
  ...
  ["context_bundle_history context_bundle_read", "MEM13"],
