...
import { Body, EmptyState, Heading, IconButton } from "../../../components";
...
export function NotesWorkspace({ books, onOpenBook }: NotesWorkspaceProps) {
  ...
  if (isLoading) {
    return (
      <div className="flex h-full items-center justify-center">
        <Body className="text-sm text-stone-500">Loading annotations...</Body>
      </div>
    );
  }
    ...
    <div className="ra-motion-page-enter mx-auto max-w-screen-2xl px-6 py-8 sm:py-10">
      <div className="mb-8">
        ...
        <Body className="mt-1 text-sm text-stone-500">
          {annotations.length} annotation{annotations.length !== 1 ? "s" : ""} across {grouped.size} book{grouped.size !== 1 ? "s" : ""}
        </Body>
      </div>
                ...
                {items.map((annotation) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="line-clamp-2 text-sm leading-relaxed text-stone-700">
